jQuery(function($){
  ...
  // add-open-class
  $('.menu-dd-item__link--open').click(function(){
   if($(this).parent().is('.menu-dd-item__link--opened')){
    $(this).parent().removeClass('menu-dd-item__link--opened');
   }else{
    $(this).parent().addClass('menu-dd-item__link--opened');
   }
  });
